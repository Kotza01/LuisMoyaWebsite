...
export const projectData = {
  projects: [
    ...
    },
    {
      ...
      info: "Ecommerce maked with sanity, next js and stripe, you can buy registered sanity product, it´s connect with stripe although its version is demo, has product list, cart, its responsive, i did it with the help of tutorial however i understand all functionallity in this app.",
